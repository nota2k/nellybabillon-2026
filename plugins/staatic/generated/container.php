...
class CachedContainer extends Container
{
    ...
    public function getRemovedIds(): array
    {
        return [
            ...
            'Staatic\WordPress\Bridge\FilterableUrlTransformer' => \true,
    ...
    {
        $a = $this->privates['Staatic\WordPress\Factory\UrlTransformerFactory'] ?? $this->getUrlTransformerFactoryService();
